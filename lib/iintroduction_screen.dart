...
import 'package:slid/home_screen.dart';
...
class IntroScreen extends StatelessWidget {
  ...
  final List<PageViewModel> pages = [
    PageViewModel(
     ...
     // ),
      image: Center(
        child: Lottie.network("https://assets2.lottiefiles.com/packages/lf20_h9rxcjpi.json"),
      ),
    ...
    PageViewModel(
        ...
        //),
        image: Center(
          child: Lottie.network("https://assets1.lottiefiles.com/packages/lf20_omn51ec8.json"),
        ),
        decoration: const PageDecoration(
            titleTextStyle: TextStyle(
              fontSize: 25.0,
    ...
    PageViewModel(
       ...
       // ),
        image: Center(
          child: Lottie.network("https://assets1.lottiefiles.com/private_files/lf30_afru6l2d.json"),
        ),
        decoration: const PageDecoration(
            titleTextStyle: TextStyle(
              fontSize: 25.0,
